...
"use strict";ApplicationConfiguration.registerModule("programs",["core"]),ApplicationConfiguration.registerModule("programs.admin",["core.admin"]),ApplicationConfiguration.registerModule("programs.admin.routes",["core.admin.routes"]);
"use strict";ApplicationConfiguration.registerModule("residents",["core"]),ApplicationConfiguration.registerModule("residents.admin",["core.admin"]),ApplicationConfiguration.registerModule("residents.admin.routes",["core.admin.routes"]);
...
"use strict";angular.module("core").controller("HomeController",["$scope","Authentication","Episodes","Programs","Residents","$http",function($scope,Authentication,Episodes,Programs,Residents,$http){$scope.authentication=Authentication,$scope.tile_limit=3,$scope.episode_tiles=Episodes.query(),$scope.program_tiles=Programs.query(),$scope.resident_tiles=Residents.query(),$http.get("api/getfeatured").then(function(data){console.log(data)})}]);
...
"use strict";angular.module("episodes").controller("EpisodesController",["$scope","$stateParams","$location","Authentication","Episodes","Residents","Programs",function($scope,$stateParams,$location,Authentication,Episodes,Residents,Programs){$scope.authentication=Authentication,$scope.days=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"],$scope.getResidents=function(){$scope.residents=Residents.query()},$scope.getPrograms=function(){$scope.programs=Programs.query()},$scope.addResident=function(resident){$scope.episode.residents.indexOf(resident)<0&&$scope.episode.residents.push(resident)},$scope.removeResident=function(resident){$scope.episode.residents=$scope.episode.residents.filter(function(obj){return obj!==resident})},$scope.getResidentName=function(resident){var resident_obj=$scope.residents.filter(function(obj){return obj._id===resident});return resident_obj[0].title},$scope.clear=function(){$scope.episode={},$scope.episode.title="",$scope.episode.image="",$scope.episode.images=[],$scope.episode.links={},$scope.episode.categories=[],$scope.episode.description={},$scope.episode.residents=[],$scope.episode.guests=[],$scope.episode.aired=new Date,$scope.program=null,$scope.episode.featured=!1},$scope.create=function(isValid){if($scope.error=null,!isValid)return $scope.$broadcast("show-errors-check-validity","episodeForm"),!1;var episode=new Episodes({title:$scope.episode.title,image:$scope.episode.image,images:$scope.episode.images,links:$scope.episode.links,categories:$scope.episode.categories,description:$scope.episode.description,residents:$scope.episode.residents,guests:$scope.episode.guests,aired:$scope.episode.aired,program:$scope.program,featured:$scope.episode.featured});episode.$save(function(response){$location.path("episodes/"+response._id),$scope.clear()},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.remove=function(episode){if(episode){episode.$remove();for(var i in $scope.episodes)$scope.episodes[i]===episode&&$scope.episodes.splice(i,1)}else $scope.episode.$remove(function(){$location.path("episodes")})},$scope.update=function(isValid){if($scope.error=null,!isValid)return $scope.$broadcast("show-errors-check-validity","episodeForm"),!1;var episode=$scope.episode;episode.$update(function(){$location.path("episodes/"+episode._id)},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.find=function(){$scope.episodes=Episodes.query({},function(data){var item=data[Math.floor(Math.random()*data.length)];$scope.changeBg(item.image)})},$scope.findOne=function(){$scope.episode=Episodes.get({episodeId:$stateParams.episodeId},function(data){$scope.changeBg(data.image)}),$scope.resident=Residents.get({episodeId:$stateParams.episodeId}),$scope.programs=Programs.query({episodeId:$stateParams.episodeId})}}]);
...
"use strict";angular.module("programs").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Programs",state:"programs",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","programs",{title:"Programs",state:"programs.list"}),Menus.addSubMenuItem("topbar","programs",{title:"Create Programs",state:"programs.create",roles:["user"]})}]);
"use strict";angular.module("programs").config(["$stateProvider",function($stateProvider){$stateProvider.state("programs",{"abstract":!0,url:"/programs",template:'<div class="view"><ui-view/></div>'}).state("programs.list",{url:"",templateUrl:"modules/programs/client/views/list-programs.client.view.html"}).state("programs.create",{url:"/create",templateUrl:"modules/programs/client/views/create-program.client.view.html",data:{roles:["user","admin"]}}).state("programs.view",{url:"/:programId",templateUrl:"modules/programs/client/views/view-program.client.view.html"}).state("programs.edit",{url:"/:programId/edit",templateUrl:"modules/programs/client/views/edit-program.client.view.html",data:{roles:["user","admin"]}})}]);
"use strict";angular.module("programs").controller("ProgramsController",["$scope","$stateParams","$location","Authentication","Programs","Residents","Episodes",function($scope,$stateParams,$location,Authentication,Programs,Residents,Episodes){$scope.authentication=Authentication,$scope.program={},$scope.program.residents=[],$scope.days=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"],$scope.getResidents=function(){$scope.residents=Residents.query()},$scope.addResident=function(title){var resident=$scope.residents.filter(function(resident){return resident.title===title})[0];$scope.program.residents.indexOf(resident)<0&&$scope.program.residents.push(resident)},$scope.removeResident=function(resident){$scope.program.residents=$scope.program.residents.filter(function(obj){return obj!==resident})},$scope.clear=function(){$scope.program={},$scope.program.title="",$scope.program.image="",$scope.program.images=[],$scope.program.links={},$scope.program.categories=[],$scope.program.description={},$scope.program.residents=[],$scope.program.schedule={},$scope.program.featured=!1},$scope.create=function(isValid){if($scope.error=null,!isValid)return $scope.$broadcast("show-errors-check-validity","programForm"),!1;var program=new Programs({title:$scope.program.title,image:$scope.program.image,images:$scope.program.images,links:$scope.program.links,categories:$scope.program.categories,description:$scope.program.description,residents:$scope.program.residents,schedule:$scope.program.schedule,featured:$scope.program.featured});program.$save(function(response){$location.path("programs/"+response._id),$scope.clear()},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.remove=function(program){if(program){program.$remove();for(var i in $scope.programs)$scope.programs[i]===program&&$scope.programs.splice(i,1)}else $scope.program.$remove(function(){$location.path("programs")})},$scope.update=function(isValid){if($scope.error=null,!isValid)return $scope.$broadcast("show-errors-check-validity","programForm"),!1;var program=$scope.program;program.$update(function(){$location.path("programs/"+program._id)},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.find=function(){$scope.programs=Programs.query({},function(data){var item=data[Math.floor(Math.random()*data.length)];$scope.changeBg(item.image)})},$scope.findOne=function(){$scope.program=Programs.get({programId:$stateParams.programId},function(data){$scope.changeBg(data.image)}),$scope.episodes=Episodes.query({programId:$stateParams.programId,limit:10})}}]);
"use strict";angular.module("programs").factory("Programs",["$resource",function($resource){return $resource("api/programs/:programId",{programId:"@_id"},{update:{method:"PUT"}})}]);
"use strict";angular.module("residents").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Residents",state:"residents",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","residents",{title:"Residents",state:"residents.list"}),Menus.addSubMenuItem("topbar","residents",{title:"Create Residents",state:"residents.create",roles:["user"]})}]);
"use strict";angular.module("residents").config(["$stateProvider",function($stateProvider){$stateProvider.state("residents",{"abstract":!0,url:"/residents",template:'<div class="view"><ui-view/></div>'}).state("residents.list",{url:"",templateUrl:"modules/residents/client/views/list-residents.client.view.html"}).state("residents.create",{url:"/create",templateUrl:"modules/residents/client/views/create-resident.client.view.html",data:{roles:["user","admin"]}}).state("residents.view",{url:"/:residentId",templateUrl:"modules/residents/client/views/view-resident.client.view.html"}).state("residents.edit",{url:"/:residentId/edit",templateUrl:"modules/residents/client/views/edit-resident.client.view.html",data:{roles:["user","admin"]}})}]);
"use strict";angular.module("residents").controller("ResidentsController",["$scope","$stateParams","$location","Authentication","Residents","Programs","Episodes",function($scope,$stateParams,$location,Authentication,Residents,Programs,Episodes){$scope.authentication=Authentication,$scope.clear=function(){$scope.resident.title="",$scope.resident.image="",$scope.resident.images=[],$scope.resident.links={},$scope.resident.categories=[],$scope.resident.description={},$scope.resident.guest=!1,$scope.resident.featured=!1},$scope.create=function(isValid){if($scope.error=null,!isValid)return $scope.$broadcast("show-errors-check-validity","residentForm"),!1;var resident=new Residents({title:$scope.resident.title,image:$scope.resident.image,images:$scope.resident.images,links:$scope.resident.links,categories:$scope.resident.categories,description:$scope.resident.description,guest:$scope.resident.guest,featured:$scope.resident.featured});resident.$save(function(response){$location.path("residents/"+response._id),$scope.clear()},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.remove=function(resident){if(resident){resident.$remove();for(var i in $scope.residents)$scope.residents[i]===resident&&$scope.residents.splice(i,1)}else $scope.resident.$remove(function(){$location.path("residents")})},$scope.update=function(isValid){if($scope.error=null,!isValid)return $scope.$broadcast("show-errors-check-validity","residentForm"),!1;var resident=$scope.resident;resident.$update(function(){$location.path("residents/"+resident._id)},function(errorResponse){$scope.error=errorResponse.data.message})},$scope.find=function(){$scope.residents=Residents.query({},function(data){var item=data[Math.floor(Math.random()*data.length)];$scope.changeBg(item.image)})},$scope.findOne=function(){$scope.resident=Residents.get({residentId:$stateParams.residentId},function(data){$scope.changeBg(data.image)}),$scope.programs=Programs.query({residentId:$stateParams.residentId,limit:5}),$scope.episodes=Episodes.query({residentId:$stateParams.residentId,limit:10})}}]);
"use strict";angular.module("residents").factory("Residents",["$resource",function($resource){return $resource("api/residents/:residentId",{residentId:"@_id"},{update:{method:"PUT"}})}]);
