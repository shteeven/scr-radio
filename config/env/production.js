...
module.exports = {
  ...
  port: process.env.PORT || local.PORT || 8443,
  db: {
  ...
  log: {
    ...
    options: {
      ...
      stream: {
        directoryPath: process.env.LOG_DIR_PATH || local.LOG_DIR_PATH || process.cwd(),
  ...
  facebook: {
    ...
    clientSecret: process.env.FACEBOOK_SECRET || local.FACEBOOK_SECRET || 'APP_SECRET',
