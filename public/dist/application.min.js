...
"use strict";var app=angular.module("core");app.directive("scrLinks",["$http","$rootScope","$sce",function($http,$rootScope,$sce){return{restrict:"E",scope:{data:"="},controller:["$scope","$element",function($scope,$element){$scope.links={facebook:"https://www.facebook.com/shteeven",twitter:"https://about.twitter.com/?utm_source=google&utm_medium=cpc&utm_campaign=PFX_SEM_GW_US_EVERGREEN_TIER%201_EXACT_LPTESTABOUT&utm_content=Twitter&utm_term=twitter&gclid=CjwKEAiAgKu2BRDu1OGw3-KXokwSJAB_Yy2QotutFQSUIwmfVBG89i16JZMaDpiV6M6hgN0EKYpsihoC4P7w_wcB&gclsrc=aw.ds",homepage:"https://www.facebook.com/shteeven",mixcloud:"https://www.facebook.com/shteeven"}}],templateUrl:"modules/core/client/views/components/links.html"}}]);
...
"use strict";var app=angular.module("core");app.directive("scrTiles",["$rootScope","$http",function($rootScope,$http){return{restrict:"EA",scope:{limit:"@",tiles:"=",template:"@"},controller:["$scope","$element",function($scope,$element){$scope.playPlayer=function(track){$rootScope.$broadcast("player.play",{track:track})},$scope.contentUrl="modules/core/client/views/components/tiles-"+$scope.template+".html"}],template:'<div ng-include="contentUrl" ng-class="[template]"></div>'}}]);
