...
"use strict";angular.module("djs").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Djs",state:"djs",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","djs",{title:"List Djs",state:"djs.list"}),Menus.addSubMenuItem("topbar","djs",{title:"Create Djs",state:"djs.create",roles:["user"]})}]);
