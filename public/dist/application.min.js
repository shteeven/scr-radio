...
"use strict";angular.module("core").controller("HeaderController",["$scope","$state","Authentication","Menus",function($scope,$state,Authentication,Menus){$scope.$state=$state,$scope.authentication=Authentication,$scope.menu=Menus.getMenu("topbar"),$scope.main_links={facebook:"https://www.facebook.com/seoulcommunityradio/",twitter:"https://about.twitter.com/?utm_source=google&utm_medium=cpc&utm_campaign=PFX_SEM_GW_US_EVERGREEN_TIER%201_EXACT_LPTESTABOUT&utm_content=Twitter&utm_term=twitter&gclid=CjwKEAiAgKu2BRDu1OGw3-KXokwSJAB_Yy2QotutFQSUIwmfVBG89i16JZMaDpiV6M6hgN0EKYpsihoC4P7w_wcB&gclsrc=aw.ds",home:"https://www.facebook.com/shteeven",mixcloud:"https://www.facebook.com/shteeven"},$scope.isCollapsed=!1,$scope.toggleCollapsibleMenu=function(){$scope.isCollapsed=!$scope.isCollapsed},$scope.$on("$stateChangeSuccess",function(){$scope.isCollapsed=!1})}]);
