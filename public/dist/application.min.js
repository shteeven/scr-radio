...
"use strict";angular.module("core").controller("HomeController",["$scope","Authentication",function($scope,Authentication){$scope.authentication=Authentication,$scope.tile_limit=3}]);
...
"use strict";var app=angular.module("core");app.directive("scrTiles",["$rootScope","$http",function($rootScope,$http){return{restrict:"EA",scope:{limit:"@",data:"="},controller:["$scope","$element",function($scope,$element){$http.get("modules/core/client/data/mixcloud-shows.json").then(function(data){$scope.tiles=data.data}),$scope.playPlayer=function(track){$rootScope.$broadcast("player.play",{track:track})}}],templateUrl:"modules/core/client/views/components/tiles.html"}}]);
